      ...
      <div class="flex items-center justify-between h-16 -mb-px">
        ...
        <div class="flex items-center">
          <div>
            ...
            <div
              id="search-modal"
              class="fixed inset-0 z-50 overflow-hidden flex items-start top-20 mb-4 justify-center transform px-4 sm:px-6 exit-done"
              role="dialog"
              aria-modal="true"
              style="display: none;"
            >
                    ...
                    <ul class="text-sm">
                      <li>
                        ...
                        >
                          ...
                          <span>
                            <span class="font-medium text-gray-800 group-hover:text-white">Messages</span>
                      ...
                      <li>
                        ...
                        >
                          ...
                          <span>
                            <span class="font-medium text-gray-800 group-hover:text-white">Messages</span> - Conversation / … / Eva Patrick
                          </span>
                        </a>
                      </li>
                    </ul>
          ...
          <div class="relative inline-flex ml-3">
            <button
              class="w-8 h-8 flex items-center justify-center bg-gray-100 hover:bg-gray-200 transition duration-150 rounded-full false"
              aria-haspopup="true"
              aria-expanded="false"
              style="outline: none;"
            >
            ...
            <div
              class="origin-top-right z-10 absolute top-full right-0 -mr-48 sm:mr-0 min-w-80 bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1 exit-done"
              style="display: none;"
            >
              <div>
                <div
                ...
                <ul>
                  <li class="border-b border-gray-200 last:border-0">
                    <a class="block py-2 px-4 hover:bg-gray-50" href="/#0" style="outline: none;">
